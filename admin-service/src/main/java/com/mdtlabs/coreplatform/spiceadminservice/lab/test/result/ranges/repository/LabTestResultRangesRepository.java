...
public interface LabTestResultRangesRepository extends JpaRepository<LabTestResultRange, Long> {
	...
	public static final String REMOVE_LAB_TEST_RESULT_RANGE = "UPDATE LabTestResultRange "
		+ "SET isDeleted = :isDeleted WHERE id = :id";

	public static final String GET_LAB_TEST_RESULT_RANGES = "SELECT * FROM LabTestResultRange"
		+ " WHERE Id IN (:ids) AND is_deleted = :isDeleted";
	 ...
	 */
	public List<LabTestResultRange> findByLabTestResultIdAndIsDeleted(
